...
public class FindPatient extends TestBase{
    ...
    public static Object[][] patiendatareader() {
        try {
            requestDataList = jsonreader.readJsonFile("com/Petal/Findrequest.json", 
    ...
    public void testFindPatient(patientdatareader request) {
        ...
        Response response = RestAssured.given()
                ...
                .body(request)
                .when()
                .post("/Patients/booking_hub/patients/find_patient");
        System.out.println("Status Code for Find Patient endpoint with "+request.getHin()+" is "+response.statusCode());
